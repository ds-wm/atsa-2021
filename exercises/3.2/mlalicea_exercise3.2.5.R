...
# Overall, the maximum likelihood estimator shows the least variance, which aligns with the class notes stating that it is best to use ML estimators in stationary models
