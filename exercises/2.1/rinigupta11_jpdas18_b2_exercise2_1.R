...
mins.15.ts.adc0 <- ts(fifteen.minutes$adc0, start = c(2010, 2011, 2012))
mins.15.ts.adc0.nodup <- ts(fifteen.minutes.nodup$adc0, start = c(2010, 2011, 2012))
...
hour.ts.adc0 <- ts(sixty.minutes$adc0, start = c(2010, 2011, 2012))
hour.ts.adc0.nodup <- ts(sixty.minutes.nodup$adc0, start = c(2010, 2011, 2012))
...
hours.12.ts.adc0 <- ts(twelve.hour$adc0, start = c(2010, 2011, 2012))
hours.12.ts.adc0.nodup <- ts(twelve.hour.nodup$adc0, start = c(2010, 2011, 2012))
...
day.ts.adc0 <- ts(day$adc0, start = c(2010, 2011, 2012))
day.ts.adc0.nodup <- ts(day.nodup$adc0, start = c(2010, 2011, 2012))
...
hour.ts.adc1 <- ts(sixty.minutes$adc1, start = c(2010, 2011, 2012))
hour.ts.adc1.nodup <- ts(sixty.minutes.nodup$adc1, start = c(2010, 2011, 2012))
...
hours.12.ts.adc1 <- ts(twelve.hour$adc1, start = c(2010, 2011, 2012))
hours.12.ts.adc1.nodup <- ts(twelve.hour.nodup$adc1, start = c(2010, 2011, 2012))
...
day.ts.adc1 <- ts(day$adc1, start = c(2010, 2011, 2012))
day.ts.adc1.nodup <- ts(day.nodup$adc1, start = c(2010, 2011, 2012))
...
mins.15.ts.adc2 <- ts(fifteen.minutes$adc2, start = c(2010, 2011, 2012))
mins.15.ts.adc2.nodup <- ts(fifteen.minutes.nodup$adc2, start = c(2010, 2011, 2012))
...
hour.ts.adc2 <- ts(sixty.minutes$adc2, start = c(2010, 2011, 2012))
hour.ts.adc2.nodup <- ts(sixty.minutes.nodup$adc2, start = c(2010, 2011, 2012))
...
hours.12.ts.adc2 <- ts(twelve.hour$adc2, start = c(2010, 2011, 2012))
hours.12.ts.adc2.nodup <- ts(twelve.hour.nodup$adc2, start = c(2010, 2011, 2012))
...
day.ts.adc2 <- ts(day$adc2, start = c(2010, 2011, 2012))
day.ts.adc2.nodup <- ts(day.nodup$adc2, start = c(2010, 2011, 2012))
